...
public class Client {
    ...
    /**
     Sending initial message to server (server will announce that client is connected).
     */
    ...
    /**
     Sending disconnect message to server (server will announce that client is disconnected),
